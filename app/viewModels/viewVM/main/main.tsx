...
const Main=()=>{
    ...
    return (
        <View style={{flex: 1}}>
            <NavigationService >
                <MainStack.Navigator initialRouteName={'home'} ScreenOptions={{lazy: true}}>
                    ...
                    <MainStack.Screen name={'calendar'} component={calendar} options={{header:()=><Header text={lang.head.calendar} />}}/>
                    <MainStack.Screen name={'notification'} component={notifications} options={{header:()=><Header text={lang.head.notification} />}}/>
                    <MainStack.Screen name={'menu'} component={Home} options={{header:()=><Header text={lang.head.menu} />}}/>
